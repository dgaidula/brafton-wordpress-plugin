	...
	class GADASH_GAPI {
		...
		function __construct() {
			...
			if ($GADASH_Config->options ['ga_dash_userapi']) {
				...
				$this->client->setClientId ( '692240795393-01ra96go8up8537vp0ming76qm7ra90t.apps.googleusercontent.com' );
				$this->client->setClientSecret ( 'Ho-2buY8DDgY1MDDo8ZuihUd' );
				$this->client->setDeveloperKey ( 'AIzaSyCuTFvtLH8j51EI-211U1gQfIze92f5S6k' );
			}
